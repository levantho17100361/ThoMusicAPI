package com.example.thomusicapi;
...
public class NhacAdapter extends RecyclerView.Adapter<NhacAdapter.MyViewHolder> {
    private Context context;
    private ArrayList<Nhac> nhacArrayList;
    private String url="https://5fd5aadb66125e0016500690.mockapi.io/API/ThoMockAPI/Nhac/";

    public NhacAdapter(Context context, ArrayList<Nhac> nhacArrayList) {
        this.context = context;
        this.nhacArrayList = nhacArrayList;
    }

    @NonNull
    @Override
    public com.example.thomusicapi.NhacAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
    ...
    @Override
    public void onBindViewHolder(@NonNull com.example.thomusicapi.NhacAdapter.MyViewHolder holder, int position) {
        holder.id.setText("#"+ String.valueOf(position+1));
        holder.name.setText(nhacArrayList.get(position).getName());
        holder.edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int id= nhacArrayList.get(position).getId();
                String value= nhacArrayList.get(position).getName();
                editGame(id, value);
            }
        });
    ...
    public class MyViewHolder  extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            name= itemView.findViewById(R.id.tv_nhac);
        }
    }
}